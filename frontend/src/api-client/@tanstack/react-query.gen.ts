...
export const getApiDynamicQueriesByIdGenerateQueryKey = (
  options: Options<GetApiDynamicQueriesByIdGenerateData>
) => createQueryKey('getApiDynamicQueriesByIdGenerate', options);

/**
 * Generate Dynamic Query
 * Endpoint to generate a dynamic query by ID
 */
export const getApiDynamicQueriesByIdGenerateOptions = (
  options: Options<GetApiDynamicQueriesByIdGenerateData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await getApiDynamicQueriesByIdGenerate({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: getApiDynamicQueriesByIdGenerateQueryKey(options),
  });
};

export const getApiDynamicQueriesByIdResultsQueryKey = (
  options: Options<GetApiDynamicQueriesByIdResultsData>
) => createQueryKey('getApiDynamicQueriesByIdResults', options);

/**
 * Get Dynamic Query Results
 * Endpoint to retrieve a dynamic query results by ID
 */
export const getApiDynamicQueriesByIdResultsOptions = (
  options: Options<GetApiDynamicQueriesByIdResultsData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await getApiDynamicQueriesByIdResults({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: getApiDynamicQueriesByIdResultsQueryKey(options),
  });
};
