...
-- +goose Down
-- +goose StatementBegin
DROP TABLE IF EXISTS dynamic_query_aggregates;
DROP TABLE IF EXISTS dynamic_query_orders;
DROP TABLE IF EXISTS dynamic_query_clauses;
DROP TABLE IF EXISTS dynamic_query_joins;
DROP TABLE IF EXISTS dynamic_query_columns;
DROP TABLE IF EXISTS dynamic_query_child_queries;
DROP TABLE IF EXISTS dynamic_queries;
DROP TYPE IF EXISTS aggregate_type;
DROP TYPE IF EXISTS join_type;
